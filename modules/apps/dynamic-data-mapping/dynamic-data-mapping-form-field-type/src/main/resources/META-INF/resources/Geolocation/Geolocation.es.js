...
class Geolocation extends Component {
	...
	attached() {
		...
		var valor = JSON.parse(this.value);

		MAP_CONFIG.position.location.lat = valor.latitude;

		MAP_CONFIG.position.location.lng = valor.longitude;
	...
	_eventHandlerPositionChange({newVal: {location}}) {
		...
		document
			.getElementById(`${this.instanceId}_input_value`)
			.setAttribute('value', JSON.stringify(value));
